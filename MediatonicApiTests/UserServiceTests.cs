    ...
    class UserServiceTests
    {
        ...
        public void TestAnimalInvalidUser()
        {
            ...
            using (ApiContext context = new ApiContext(dbOptions)) {
                ...
                Assert.Catch<System.ArgumentException>(() => service.AddAnimalToUser(user.Id + 1, animal.Id));
            }
        ...
        public void TestAnimalInvalidAnimal()
        {
            ...
            using (ApiContext context = new ApiContext(dbOptions)) {
                ...
                Assert.Catch<System.ArgumentException>(() => service.AddAnimalToUser(user.Id, animal.Id + 1));
            }
        ...
        public void TestAnimalAlreadyExists()
        {
            ...
            using (ApiContext context = new ApiContext(dbOptions)) {
                ...
                Assert.Catch<System.ArgumentException>(() => service.AddAnimalToUser(user.Id, animal.Id));
            }
        ...
        public void TestGetInvalid()
        {
            ...
            using (ApiContext context = new ApiContext(dbOptions)) {
                ...
                Assert.IsNull(service.Get(user.Id + 1));
            }
        }
